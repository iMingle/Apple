...
AmCharts.getObjById=function(a,b){var c,d;for(d=0;d<a.length;d++){var f=a[d];f.id==b&&(c=f)}return c};AmCharts.applyTheme=function(a,b,c){b&&b[c]&&AmCharts.extend(a,b[c])};AmCharts.isString=function(a){return"string"==typeof a?!0:!1};AmCharts.extend=function(a,b,c){for(var d in b)c?a.hasOwnProperty(d)||(a[d]=b[d]):a[d]=b[d];return a};AmCharts.copyProperties=function(a,b){for(var c in a)a.hasOwnProperty(c)&&"events"!=c&&void 0!==a[c]&&"function"!=typeof a[c]&&(b[c]=a[c])};
AmCharts.processObject=function(a,b,c){!1===a instanceof b&&(a=AmCharts.extend(new b(c),a));return a};AmCharts.fixNewLines=function(a){if(!AmCharts.isModern){var b=RegExp("\\n","g");a&&(a=a.replace(b,"<br />"))}return a};
...
c,u);this.pushAxisItem(u);if(q==this.baseValue&&"radar"!=k){var ca,P,H=this.viW,z=this.viH;u=this.viX;y=this.viY;"H"==this.orientation?0<=c&&c<=H+1&&(ca=[c,c,c+f],P=[z,0,e]):0<=c&&c<=z+1&&(ca=[0,H,H+f],P=[c,c,c+e]);ca&&(c=AmCharts.fitToBounds(2*this.gridAlpha,0,1),c=AmCharts.line(a.container,ca,P,this.gridColor,c,1,this.dashLength),c.translate(u,y),this.grid0=c,a.axesSet.push(c),c.toBack())}if(!isNaN(B)&&0<F&&d<t-1){u=this.gridAlpha;this.gridAlpha=this.minorGridAlpha;for(c=1;c<s/B;c++)y=this.getCoordinate(q+
...
a);b.axesSet.push(d);this.set=d}});AmCharts.RecItem=AmCharts.Class({construct:function(a,b,c,d,f,e,g,h,k,l){b=Math.round(b);void 0==c&&(c="");k||(k=0);void 0==d&&(d=!0);var m=a.chart.fontFamily,n=a.fontSize;void 0==n&&(n=a.chart.fontSize);var p=a.color;void 0==p&&(p=a.chart.color);var q=a.chart.container,t=q.set();this.set=t;var r=a.axisThickness,s=a.axisColor,w=a.axisAlpha,v=a.tickLength,u=a.gridAlpha,A=a.gridThickness,F=a.gridColor,y=a.dashLength,z=a.fillColor,H=a.fillAlpha,I=a.labelsEnabled,B=a.labelRotation,ca=a.counter,P=a.inside,
da=a.dx,W=a.dy,Fa=a.orientation,ea=a.position,Z=a.previousCoord,L=a.viH,V=a.viW,na=a.offset,X,Y;g?(I=!0,isNaN(g.tickLength)||(v=g.tickLength),void 0!=g.lineColor&&(F=g.lineColor),void 0!=g.color&&(p=g.color),isNaN(g.lineAlpha)||(u=g.lineAlpha),isNaN(g.dashLength)||(y=g.dashLength),isNaN(g.lineThickness)||(A=g.lineThickness),!0===g.inside&&(P=!0),isNaN(g.labelRotation)||(B=g.labelRotation),isNaN(g.fontSize)||(n=g.fontSize),g.position&&(ea=g.position)):""===c&&(v=0);Y="start";f&&(Y="middle");var $=
B*Math.PI/180,ha,G=0,E=0,ia=0,R=ha=0;"V"==Fa&&(B=0);var x;I&&(x=AmCharts.text(q,c,p,m,n,Y,h),R=x.getBBox().width);if("H"==Fa){if(0<=b&&b<=V+1&&(0<v&&0<w&&b+k<=V+1&&(X=AmCharts.line(q,[b+k,b+k],[0,v],s,w,A),t.push(X)),0<u&&(Y=AmCharts.line(q,[b,b+da,b+da],[L,L+W,W],F,u,A,y),t.push(Y))),E=0,G=b,g&&90==B&&(G-=n),!1===d?(Y="start",E="bottom"==ea?P?E+v:E-v:P?E-v:E+v,G+=3,f&&(G+=f/2,Y="middle"),0<B&&(Y="middle")):Y="middle",1==ca&&0<H&&!g&&!l&&Z<V&&(d=AmCharts.fitToBounds(b,0,V),Z=AmCharts.fitToBounds(Z,
0,V),ha=d-Z,0<ha&&(fill=AmCharts.rect(q,ha,a.height,z,H),fill.translate(d-ha+da,W),t.push(fill))),"bottom"==ea?(E+=L+n/2+na,P?0<B?(E=L-R/2*Math.sin($)-v-3,G+=R/2*Math.cos($)):0>B?(E-=v+n+3+3-R/2*Math.sin($),G-=R/2*Math.cos($)):E-=v+n+3+3:0<B?(E=L+R/2*Math.sin($)+v+3,G-=R/2*Math.cos($)):0>B?(E=L+v+3-R/2*Math.sin($)+2,G+=R/2*Math.cos($)):E+=v+r+3+3):(E+=W+n/2-na,G+=da,P?0<B?(E=R/2*Math.sin($)+v+3,G-=R/2*Math.cos($)):E+=v+3:0<B?(E=-(R/2)*Math.sin($)-v-6,G+=R/2*Math.cos($)):E-=v+n+3+r+3),"bottom"==ea?
ha=(P?L-v-1:L+r-1)+na:(ia=da,ha=(P?W:W-v-r+1)-na),e&&(G+=e),W=G,0<B&&(W+=R/2*Math.cos($)),x&&(ea=0,P&&(ea=R/2*Math.cos($)),W+ea>V+2||0>W))x.remove(),x=null}else{0<=b&&b<=L+1&&(0<v&&0<w&&b+k<=L+1&&(X=AmCharts.line(q,[0,v],[b+k,b+k],s,w,A),t.push(X)),0<u&&(Y=AmCharts.line(q,[0,da,V+da],[b,b+W,b+W],F,u,A,y),t.push(Y)));Y="end";if(!0===P&&"left"==ea||!1===P&&"right"==ea)Y="start";E=b-n/2;1==ca&&0<H&&!g&&!l&&(d=AmCharts.fitToBounds(b,0,L),Z=AmCharts.fitToBounds(Z,0,L),$=d-Z,fill=AmCharts.polygon(q,[0,
a.width,a.width,0],[0,0,$,$],z,H),fill.translate(da,d-$+W),t.push(fill));E+=n/2;"right"==ea?(G+=da+V+na,E+=W,P?(G-=v+4,e||(E-=n/2+3)):(G+=v+4+r,E-=2)):P?(G+=v+4-na,e||(E-=n/2+3),g&&(G+=da,E+=W)):(G+=-v-r-4-2-na,E-=2);X&&("right"==ea?(ia+=da+na+V,ha+=W,ia=P?ia-r:ia+r):(ia-=na,P||(ia-=v+r)));e&&(E+=e);P=-3;"right"==ea&&(P+=W);x&&(E>L+1||E<P)&&(x.remove(),x=null)}X&&X.translate(ia,ha);!1===a.visible&&(X&&X.remove(),x&&(x.remove(),x=null));x&&(x.attr({"text-anchor":Y}),x.translate(G,E),0!==B&&x.rotate(-B,
a.chart.backgroundColor),a.allLabels.push(x)," "!=c&&(this.label=x));l||(a.counter=0===ca?1:0,a.previousCoord=b);0===this.set.node.childNodes.length&&this.set.remove()},graphics:function(){return this.set},getLabel:function(){return this.label}});AmCharts.RecFill=AmCharts.Class({construct:function(a,b,c,d){var f=a.dx,e=a.dy,g=a.orientation,h=0;if(c<b){var k=b;b=c;c=k}var l=d.fillAlpha;isNaN(l)&&(l=0);k=a.chart.container;d=d.fillColor;"V"==g?(b=AmCharts.fitToBounds(b,0,a.viH),c=AmCharts.fitToBounds(c,0,a.viH)):(b=AmCharts.fitToBounds(b,0,a.viW),c=AmCharts.fitToBounds(c,0,a.viW));c-=b;isNaN(c)&&(c=4,h=2,l=0);0>c&&"object"==typeof d&&(d=d.join(",").split(",").reverse());"V"==g?(a=AmCharts.rect(k,a.width,c,d,l),a.translate(f,b-h+e)):(a=AmCharts.rect(k,
c,a.height,d,l),a.translate(b-h+f,e));this.set=k.set([a])},graphics:function(){return this.set},getLabel:function(){}});AmCharts.AmChart=AmCharts.Class({construct:function(a){this.theme=a;this.version="3.3.1";AmCharts.addChart(this);this.createEvents("dataUpdated","init","rendered","drawn");this.height=this.width="100%";this.dataChanged=!0;this.chartCreated=!1;this.previousWidth=this.previousHeight=0;this.backgroundColor="#FFFFFF";this.borderAlpha=this.backgroundAlpha=0;this.color=this.borderColor="#000000";this.fontFamily="Verdana";this.fontSize=11;this.usePrefixes=!1;this.numberFormatter={precision:-1,decimalSeparator:".",
...
d.text,f,this.fontFamily,e);f.translate(g+(this.realWidth-this.marginRight-g)/2,b);g=!0;void 0!==d.bold&&(g=d.bold);g&&f.attr({"font-weight":"bold"});b+=e+6;this.freeLabelsSet.push(f)}}},write:function(a){var b=this.exportConfig;b&&AmCharts.AmExport&&!this.AmExport&&(this.AmExport=new AmCharts.AmExport(this,b));a="object"!=typeof a?document.getElementById(a):a;a.innerHTML="";this.div=a;a.style.overflow="hidden";a.style.textAlign="left";var b=this.chartDiv,c=this.legendDiv,d=this.legend,f=c.style,
e=b.style;this.measure();var g,h;g=document.createElement("div");h=g.style;h.position="relative";this.containerDiv=g;a.appendChild(g);if(d)switch(d=this.addLegend(d,d.divId),d.position){case "bottom":g.appendChild(b);g.appendChild(c);break;case "top":g.appendChild(c);g.appendChild(b);break;case "absolute":h.width=a.style.width;h.height=a.style.height;f.position="absolute";e.position="absolute";void 0!==d.left&&(f.left=d.left+"px");void 0!==d.right&&(f.right=d.right+"px");void 0!==d.top&&(f.top=d.top+
"px");void 0!==d.bottom&&(f.bottom=d.bottom+"px");d.marginLeft=0;d.marginRight=0;g.appendChild(b);g.appendChild(c);break;case "right":h.width=a.style.width;h.height=a.style.height;f.position="relative";e.position="absolute";g.appendChild(b);g.appendChild(c);break;case "left":h.width=a.style.width;h.height=a.style.height;f.position="absolute";e.position="relative";g.appendChild(b);g.appendChild(c);break;case "outside":g.appendChild(b)}else g.appendChild(b);this.listenersAdded||(this.addListeners(),
...
(b=window.getComputedStyle(b,null))&&(this.dmouseY=AmCharts.removePx(b.getPropertyValue("margin-top")),this.dmouseX=AmCharts.removePx(b.getPropertyValue("margin-left")));this.mouseMode=a;a=new AmCharts.AmDraw(this.chartDiv,this.realWidth,this.realHeight,this);a.handDrawn=this.handDrawn;a.handDrawScatter=this.handDrawScatter;a.handDrawThickness=this.handDrawThickness;this.container=a;if(AmCharts.VML||AmCharts.SVG)a=this.container,this.set=a.set(),this.gridSet=a.set(),this.graphsBehindSet=a.set(),this.bulletBehindSet=
a.set(),this.columnSet=a.set(),this.graphsSet=a.set(),this.trendLinesSet=a.set(),this.axesLabelsSet=a.set(),this.axesSet=a.set(),this.cursorSet=a.set(),this.scrollbarsSet=a.set(),this.bulletSet=a.set(),this.freeLabelsSet=a.set(),this.balloonsSet=a.set(),this.balloonsSet.setAttr("id","balloons"),this.zoomButtonSet=a.set(),this.linkSet=a.set(),this.brrr(),this.renderFix()},measure:function(){var a=this.div,b=this.chartDiv,c=a.offsetWidth,d=a.offsetHeight,f=this.container;a.clientHeight&&(c=a.clientWidth,
d=a.clientHeight);var e=AmCharts.removePx(AmCharts.getStyle(a,"padding-left")),g=AmCharts.removePx(AmCharts.getStyle(a,"padding-right")),h=AmCharts.removePx(AmCharts.getStyle(a,"padding-top")),k=AmCharts.removePx(AmCharts.getStyle(a,"padding-bottom"));isNaN(e)||(c-=e);isNaN(g)||(c-=g);isNaN(h)||(d-=h);isNaN(k)||(d-=k);e=a.style;a=e.width;e=e.height;-1!=a.indexOf("px")&&(c=AmCharts.removePx(a));-1!=e.indexOf("px")&&(d=AmCharts.removePx(e));a=AmCharts.toCoordinate(this.width,c);e=AmCharts.toCoordinate(this.height,
...
AmCharts.Guide=AmCharts.Class({construct:function(){}});AmCharts.AmGraph=AmCharts.Class({construct:function(a){this.createEvents("rollOverGraphItem","rollOutGraphItem","clickGraphItem","doubleClickGraphItem","rightClickGraphItem","clickGraph");this.type="line";this.stackable=!0;this.columnCount=1;this.columnIndex=0;this.centerCustomBullets=this.showBalloon=!0;this.maxBulletSize=50;this.minBulletSize=0;this.balloonText="[[value]]";this.hidden=this.scrollbar=this.animationPlayed=!1;this.pointPosition="middle";this.depthCount=1;this.includeInMinMax=!0;this.negativeBase=
0;this.visibleInLegend=!0;this.showAllValueLabels=!1;this.showBalloonAt="close";this.lineThickness=1;this.dashLength=0;this.connect=!0;this.lineAlpha=1;this.bullet="none";this.bulletBorderThickness=2;this.bulletBorderAlpha=0;this.bulletAlpha=1;this.bulletSize=8;this.hideBulletsCount=this.bulletOffset=0;this.labelPosition="top";this.cornerRadiusTop=0;this.cursorBulletAlpha=1;this.gradientOrientation="vertical";this.dy=this.dx=0;this.periodValue="";this.clustered=!0;this.y=this.x=0;AmCharts.applyTheme(this,
a,"AmGraph")},draw:function(){var a=this.chart,b=a.container;this.container=b;this.destroy();var c=b.set(),d=b.set();this.behindColumns?(a.graphsBehindSet.push(c),a.bulletBehindSet.push(d)):(a.graphsSet.push(c),a.bulletSet.push(d));var f=this.bulletAxis;AmCharts.isString(f)&&(this.bulletAxis=a.getValueAxisById(f));this.bulletSet=d;this.scrollbar||(f=a.marginLeftReal,a=a.marginTopReal,c.translate(f,a),d.translate(f,a));b=b.set();AmCharts.remove(this.columnsSet);c.push(b);this.set=c;this.columnsSet=
b;this.columnsArray=[];this.ownColumns=[];this.allBullets=[];this.animationArray=[];AmCharts.ifArray(this.data)&&(c=!1,"xy"==this.chartType?this.xAxis.axisCreated&&this.yAxis.axisCreated&&(c=!0):this.valueAxis.axisCreated&&(c=!0),!this.hidden&&c&&this.createGraph())},createGraph:function(){var a=this,b=a.chart;"inside"==a.labelPosition&&"column"!=a.type&&(a.labelPosition="bottom");a.startAlpha=b.startAlpha;a.seqAn=b.sequencedAnimation;a.baseCoord=a.valueAxis.baseCoord;a.fillColors||(a.fillColors=
a.lineColor);void 0===a.fillAlphas&&(a.fillAlphas=0);void 0===a.bulletColor&&(a.bulletColor=a.lineColor,a.bulletColorNegative=a.negativeLineColor);void 0===a.bulletAlpha&&(a.bulletAlpha=a.lineAlpha);clearTimeout(a.playedTO);if(!isNaN(a.valueAxis.min)&&!isNaN(a.valueAxis.max)){switch(a.chartType){case "serial":a.createSerialGraph();"candlestick"==a.type&&1>a.valueAxis.minMaxMultiplier&&a.positiveClip(a.set);break;case "radar":a.createRadarGraph();break;case "xy":a.createXYGraph(),a.positiveClip(a.set)}a.playedTO=
setTimeout(function(){a.setAnimationPlayed.call(a)},500*a.chart.startDuration)}},setAnimationPlayed:function(){this.animationPlayed=!0},createXYGraph:function(){var a=[],b=[],c=this.xAxis,d=this.yAxis;this.pmh=d.viH+1;this.pmw=c.viW+1;this.pmy=this.pmx=0;var f;for(f=this.start;f<=this.end;f++){var e=this.data[f].axes[c.id].graphs[this.id],g=e.values,h=g.x,k=g.y,g=c.getCoordinate(h),l=d.getCoordinate(k);!isNaN(h)&&!isNaN(k)&&(a.push(g),b.push(l),(h=this.createBullet(e,g,l,f))||(h=0),k=this.labelText)&&
(e=this.createLabel(e,g,l,k),this.allBullets.push(e),this.positionLabel(g,l,e,this.labelPosition,h))}this.drawLineGraph(a,b);this.launchAnimation()},createRadarGraph:function(){var a=this.valueAxis.stackType,b=[],c=[],d,f,e;for(e=this.start;e<=this.end;e++){var g=this.data[e].axes[this.valueAxis.id].graphs[this.id],h;h="none"==a||"3d"==a?g.values.value:g.values.close;if(isNaN(h))this.drawLineGraph(b,c),b=[],c=[];else{var k=this.y-(this.valueAxis.getCoordinate(h)-this.height),l=180-360/(this.end-this.start+
1)*e;h=k*Math.sin(l/180*Math.PI);k*=Math.cos(l/180*Math.PI);b.push(h);c.push(k);(l=this.createBullet(g,h,k,e))||(l=0);var m=this.labelText;m&&(g=this.createLabel(g,h,k,m),this.allBullets.push(g),this.positionLabel(h,k,g,this.labelPosition,l));isNaN(d)&&(d=h);isNaN(f)&&(f=k)}}b.push(d);c.push(f);this.drawLineGraph(b,c);this.launchAnimation()},positionLabel:function(a,b,c,d,f){var e=c.getBBox();switch(d){case "left":a-=(e.width+f)/2+2;break;case "top":b-=(f+e.height)/2+1;break;case "right":a+=(e.width+
f)/2+2;break;case "bottom":b+=(f+e.height)/2+1}c.translate(a,b)},getGradRotation:function(){var a=270;"horizontal"==this.gradientOrientation&&(a=0);return this.gradientRotation=a},createSerialGraph:function(){this.dashLengthSwitched=this.fillColorsSwitched=this.lineColorSwitched=void 0;var a=this.chart,b=this.id,c=this.index,d=this.data,f=this.chart.container,e=this.valueAxis,g=this.type,h=this.columnWidthReal;isNaN(this.columnWidth)||(h=this.columnWidth);isNaN(h)&&(h=0.8);var k=this.width,l=this.height,
m=this.y,n=this.rotate,p=this.columnCount,q=AmCharts.toCoordinate(this.cornerRadiusTop,h/2),t=this.connect,r=[],s=[],w,v,u,A,F=this.chart.graphs.length,y,z=this.dx/this.depthCount,H=this.dy/this.depthCount,I=e.stackType,B=this.labelPosition,ca=this.start,P=this.end,da=this.scrollbar,W=this.categoryAxis,Fa=this.baseCoord,ea=this.negativeBase,Z=this.columnIndex,L=this.lineThickness,V=this.lineAlpha,na=this.lineColor,X=this.dashLength,Y=this.set,$=B,ha=this.getGradRotation(),G=this.chart.columnSpacing,
E=W.cellWidth,ia=(E*h-p)/p;G>ia&&(G=ia);var R,x,Ta,Za=l+1,$a=k+1,Ua=0,ab=0,bb,cb,Va,Wa,Ib=this.fillColors,Ja=this.negativeFillColors,za=this.negativeLineColor,Ka=this.fillAlphas,La=this.negativeFillAlphas;"object"==typeof Ka&&(Ka=Ka[0]);"object"==typeof La&&(La=La[0]);var Xa=e.getCoordinate(e.min);e.logarithmic&&(Xa=e.getCoordinate(e.minReal));this.minCoord=Xa;this.resetBullet&&(this.bullet="none");if(!da&&("line"==g||"smoothedLine"==g||"step"==g)&&(1==d.length&&"step"!=g&&"none"==this.bullet&&(this.bullet=
"round",this.resetBullet=!0),Ja||void 0!=za)){var Ga=ea;Ga>e.max&&(Ga=e.max);Ga<e.min&&(Ga=e.min);e.logarithmic&&(Ga=e.minReal);var wa=e.getCoordinate(Ga),tb=e.getCoordinate(e.max);n?(Za=l,$a=Math.abs(tb-wa),bb=l,cb=Math.abs(Xa-wa),Wa=ab=0,e.reversed?(Ua=0,Va=wa):(Ua=wa,Va=0)):($a=k,Za=Math.abs(tb-wa),cb=k,bb=Math.abs(Xa-wa),Va=Ua=0,e.reversed?(Wa=m,ab=wa):Wa=wa+1)}var xa=Math.round;this.pmx=xa(Ua);this.pmy=xa(ab);this.pmh=xa(Za);this.pmw=xa($a);this.nmx=xa(Va);this.nmy=xa(Wa);this.nmh=xa(bb);this.nmw=
xa(cb);AmCharts.isModern||(this.nmy=this.nmx=0,this.nmh=this.height);h="column"==g?(E*h-G*(p-1))/p:E*h;1>h&&(h=1);var J;if("line"==g||"step"==g||"smoothedLine"==g){if(0<ca){for(J=ca-1;-1<J;J--)if(R=d[J],x=R.axes[e.id].graphs[b],Ta=x.values.value,!isNaN(Ta)){ca=J;break}if(this.lineColorField||this.dashLengthField||this.fillColorsField)for(J=ca-1;-1<J;J--)R=d[J],x=R.axes[e.id].graphs[b],x.lineColor&&(this.bulletColorSwitched=this.lineColorSwitched=x.lineColor),x.fillColors&&(this.fillColorsSwitched=
x.fillColors),isNaN(x.dashLength)||(this.dashLengthSwitched=x.dashLength)}if(P<d.length-1)for(J=P+1;J<d.length;J++)if(R=d[J],x=R.axes[e.id].graphs[b],Ta=x.values.value,!isNaN(Ta)){P=J;break}}P<d.length-1&&P++;var T=[],U=[],Ma=!1;if("line"==g||"step"==g||"smoothedLine"==g)if(this.stackable&&"regular"==I||"100%"==I||this.fillToGraph)Ma=!0;var ub=this.noStepRisers;for(J=ca;J<=P;J++){R=d[J];x=R.axes[e.id].graphs[b];x.index=J;var M,N,K,aa,oa=NaN,D=NaN,C=NaN,Q=NaN,O=NaN,Na=NaN,Aa=NaN,Oa=NaN,Ba=NaN,ba=NaN,
ga=NaN,pa=NaN,qa=NaN,S=NaN,db=NaN,eb=NaN,ja=NaN,la=void 0,ya=Ib,Pa=Ka,ra=na,ka,sa,fb=this.pattern;void 0!=x.pattern&&(fb=x.pattern);void 0!=x.color&&(ya=x.color);x.fillColors&&(ya=x.fillColors);isNaN(x.alpha)||(Pa=x.alpha);isNaN(x.dashLength)||(X=x.dashLength);var ta=x.values;e.recalculateToPercents&&(ta=x.percents);if(ta){S=this.stackable&&"none"!=I&&"3d"!=I?ta.close:ta.value;if("candlestick"==g||"ohlc"==g)S=ta.close,eb=ta.low,Aa=e.getCoordinate(eb),db=ta.high,Ba=e.getCoordinate(db);ja=ta.open;C=
e.getCoordinate(S);isNaN(ja)||(O=e.getCoordinate(ja));if(!da)switch(this.showBalloonAt){case "close":x.y=C;break;case "open":x.y=O;break;case "high":x.y=Ba;break;case "low":x.y=Aa}var oa=R.x[W.id],ma=Math.floor(E/2),Ca=ma;"start"==this.pointPosition&&(oa-=E/2,ma=0,Ca=E);if(ub){var gb=this.columnWidth;isNaN(gb)||(ma*=gb,Ca*=gb)}da||(x.x=oa);-1E5>oa&&(oa=-1E5);oa>k+1E5&&(oa=k+1E5);n?(D=C,Q=O,O=C=oa,isNaN(ja)&&!this.fillToGraph&&(Q=Fa),Na=Aa,Oa=Ba):(Q=D=oa,isNaN(ja)&&!this.fillToGraph&&(O=Fa));S<ja&&
(x.isNegative=!0,Ja&&(ya=Ja),La&&(Pa=La),void 0!=za&&(ra=za));switch(g){case "line":isNaN(S)?t||(this.drawLineGraph(r,s,T,U),r=[],s=[],T=[],U=[]):(x.isNegative=S<ea?!0:!1,r.push(D),s.push(C),ba=D,ga=C,pa=D,qa=C,!Ma||isNaN(O)||isNaN(Q)||(T.push(Q),U.push(O)),void 0==x.lineColor&&void 0==x.fillColors&&isNaN(x.dashLength)||(this.drawLineGraph(r,s,T,U),r=[D],s=[C],T=[],U=[],this.lineColorSwitched=x.lineColor,this.fillColorsSwitched=x.fillColors,this.dashLengthSwitched=x.dashLength));break;case "smoothedLine":isNaN(S)?
t||(this.drawSmoothedGraph(r,s,T,U),r=[],s=[],T=[],U=[]):(x.isNegative=S<ea?!0:!1,r.push(D),s.push(C),ba=D,ga=C,pa=D,qa=C,!Ma||isNaN(O)||isNaN(Q)||(T.push(Q),U.push(O)),void 0==x.lineColor&&void 0==x.fillColors&&isNaN(x.dashLength)||(this.drawSmoothedGraph(r,s,T,U),r=[D],s=[C],T=[],U=[],this.lineColorSwitched=x.lineColor,this.fillColorsSwitched=x.fillColors,this.dashLengthSwitched=x.dashLength));break;case "step":isNaN(S)?t||(w=v=NaN,this.drawLineGraph(r,s,T,U),r=[],s=[],T=[],U=[]):(x.isNegative=
S<ea?!0:!1,void 0==x.lineColor&&void 0==x.fillColors&&isNaN(x.dashLength)||(this.drawLineGraph(r,s,T,U),r=[],s=[],T=[],U=[],this.lineColorSwitched=x.lineColor,this.fillColorsSwitched=x.fillColors,this.dashLengthSwitched=x.dashLength),n?(isNaN(w)||(r.push(w),s.push(C-ma)),s.push(C-ma),r.push(D),s.push(C+Ca),r.push(D),!Ma||isNaN(O)||isNaN(Q)||(T.push(u),U.push(O-ma),T.push(Q),U.push(O-ma),T.push(Q),U.push(O+Ca))):(isNaN(v)||(s.push(v),r.push(w),s.push(v),r.push(D-ma)),r.push(D-ma),s.push(C),r.push(D+
Ca),s.push(C),!Ma||isNaN(O)||isNaN(Q)||(T.push(Q-ma),U.push(A),T.push(Q-ma),U.push(O),T.push(Q+Ca),U.push(O))),w=D,v=C,u=Q,A=O,ba=D,ga=C,pa=D,qa=C,ub&&(w=v=NaN,this.drawLineGraph(r,s,T,U),r=[],s=[],T=[],U=[]));break;case "column":ka=ra;void 0!=x.lineColor&&(ka=x.lineColor);if(!isNaN(S)){S<ea?(x.isNegative=!0,Ja&&(ya=Ja),void 0!=za&&(ka=za)):x.isNegative=!1;var vb=e.min,wb=e.max;if(!(S<vb&&ja<vb||S>wb&&ja>wb))if(n){"3d"==I?(N=C-0.5*(h+G)+G/2+H*Z,M=Q+z*Z):(N=C-(p/2-Z)*(h+G)+G/2,M=Q);K=h;ba=D;ga=N+h/
2;pa=D;qa=N+h/2;N+K>l&&(K=l-N);0>N&&(K+=N,N=0);aa=D-Q;var Jb=M;M=AmCharts.fitToBounds(M,0,k);aa+=Jb-M;aa=AmCharts.fitToBounds(aa,-M,k-M+z*Z);if(N<l&&0<K&&(la=new AmCharts.Cuboid(f,aa,K,z-a.d3x,H-a.d3y,ya,Pa,L,ka,V,ha,q,n,X,fb),"bottom"!=B&&"inside"!=B&&"middle"!=B))if(B=e.reversed?"left":"right",0>S)B=e.reversed?"right":"left";else if("regular"==I||"100%"==I)ba+=this.dx}else{"3d"==I?(M=D-0.5*(h+G)+G/2+z*Z,N=O+H*Z):(M=D-(p/2-Z)*(h+G)+G/2,N=O);K=h;ba=M+h/2;ga=C;pa=M+h/2;qa=C;M+K>k+Z*z&&(K=k-M+Z*z);
0>M&&(K+=M,M=0);aa=C-O;var Kb=N;N=AmCharts.fitToBounds(N,this.dy,l);aa+=Kb-N;aa=AmCharts.fitToBounds(aa,-N+H*Z,l-N);if(M<k+Z*z&&0<K)if(la=new AmCharts.Cuboid(f,K,aa,z-a.d3x,H-a.d3y,ya,Pa,L,ka,this.lineAlpha,ha,q,n,X,fb),0>S&&"middle"!=B&&"inside"!=B)B="bottom";else if(B=$,"regular"==I||"100%"==I)ga+=this.dy}if(la&&(sa=la.set,sa.translate(M,N),this.columnsSet.push(sa),(x.url||this.showHandOnHover)&&sa.setAttr("cursor","pointer"),!da)){"none"==I&&(y=n?(this.end+1-J)*F-c:F*J+c);"3d"==I&&(n?(y=(F-c)*
(this.end+1-J),ba+=z*this.columnIndex,pa+=z*this.columnIndex,x.y+=z*this.columnIndex):(y=(F-c)*(J+1),ba+=3,ga+=H*this.columnIndex+7,qa+=H*this.columnIndex,x.y+=H*this.columnIndex));if("regular"==I||"100%"==I)"inside"!=B&&(B="middle"),y=n?0<ta.value?(this.end+1-J)*F+c:(this.end+1-J)*F-c:0<ta.value?F*J+c:F*J-c;this.columnsArray.push({column:la,depth:y});x.x=n?N+K/2:M+K/2;this.ownColumns.push(la);this.animateColumns(la,J,D,Q,C,O);this.addListeners(sa,x)}}break;case "candlestick":if(!isNaN(ja)&&!isNaN(S)){var Ya,
hb;ka=ra;void 0!=x.lineColor&&(ka=x.lineColor);if(n){if(N=C-h/2,M=Q,K=h,N+K>l&&(K=l-N),0>N&&(K+=N,N=0),N<l&&0<K){var ib,jb;S>ja?(ib=[D,Oa],jb=[Q,Na]):(ib=[Q,Oa],jb=[D,Na]);!isNaN(Oa)&&!isNaN(Na)&&C<l&&0<C&&(Ya=AmCharts.line(f,ib,[C,C],ka,V,L),hb=AmCharts.line(f,jb,[C,C],ka,V,L));aa=D-Q;la=new AmCharts.Cuboid(f,aa,K,z,H,ya,Ka,L,ka,V,ha,q,n,X)}}else if(M=D-h/2,N=O+L/2,K=h,M+K>k&&(K=k-M),0>M&&(K+=M,M=0),aa=C-O,M<k&&0<K){var la=new AmCharts.Cuboid(f,K,aa,z,H,ya,Pa,L,ka,V,ha,q,n,X),kb,lb;S>ja?(kb=[C,Ba],
lb=[O,Aa]):(kb=[O,Ba],lb=[C,Aa]);!isNaN(Ba)&&!isNaN(Aa)&&D<k&&0<D&&(Ya=AmCharts.line(f,[D,D],kb,ka,V,L),hb=AmCharts.line(f,[D,D],lb,ka,V,L))}la&&(sa=la.set,Y.push(sa),sa.translate(M,N-L/2),(x.url||this.showHandOnHover)&&sa.setAttr("cursor","pointer"),Ya&&(Y.push(Ya),Y.push(hb)),ba=D,ga=C,pa=D,qa=C,da||(x.x=n?N+K/2:M+K/2,this.animateColumns(la,J,D,Q,C,O),this.addListeners(sa,x)))}break;case "ohlc":if(!(isNaN(ja)||isNaN(db)||isNaN(eb)||isNaN(S))){S<ja&&(x.isNegative=!0,void 0!=za&&(ra=za));var mb,nb,
ob;if(n){var pb=C-h/2,pb=AmCharts.fitToBounds(pb,0,l),xb=AmCharts.fitToBounds(C,0,l),qb=C+h/2,qb=AmCharts.fitToBounds(qb,0,l);nb=AmCharts.line(f,[Q,Q],[pb,xb],ra,V,L,X);0<C&&C<l&&(mb=AmCharts.line(f,[Na,Oa],[C,C],ra,V,L,X));ob=AmCharts.line(f,[D,D],[xb,qb],ra,V,L,X)}else{var rb=D-h/2,rb=AmCharts.fitToBounds(rb,0,k),yb=AmCharts.fitToBounds(D,0,k),sb=D+h/2,sb=AmCharts.fitToBounds(sb,0,k);nb=AmCharts.line(f,[rb,yb],[O,O],ra,V,L,X);0<D&&D<k&&(mb=AmCharts.line(f,[D,D],[Aa,Ba],ra,V,L,X));ob=AmCharts.line(f,
[yb,sb],[C,C],ra,V,L,X)}Y.push(nb);Y.push(mb);Y.push(ob);ba=D;ga=C;pa=D;qa=C}}if(!da&&!isNaN(S)){var zb=this.hideBulletsCount;if(this.end-this.start<=zb||0===zb){var Da=this.createBullet(x,pa,qa,J);Da||(Da=0);var Ab=this.labelText;if(Ab){var fa=this.createLabel(x,0,0,Ab),ua=0,va=0,Bb=fa.getBBox(),Ha=Bb.width,Ea=Bb.height;switch(B){case "left":ua=-(Ha/2+Da/2+3);break;case "top":va=-(Ea/2+Da/2+3);break;case "right":ua=Da/2+2+Ha/2;break;case "bottom":n&&"column"==g?(ba=Fa,0>S?(ua=-6,fa.attr({"text-anchor":"end"})):
(ua=6,fa.attr({"text-anchor":"start"}))):(va=Da/2+Ea/2,fa.x=-(Ha/2+2));break;case "middle":"column"==g&&(n?(va=-(Ea/2)+this.fontSize/2,ua=-(D-Q)/2-z,0>aa&&(ua+=z),Math.abs(D-Q)<Ha&&!this.showAllValueLabels&&(fa.remove(),fa=null)):(va=-(C-O)/2,0>aa&&(va-=H),Math.abs(C-O)<Ea&&!this.showAllValueLabels&&(fa.remove(),fa=null)));break;case "inside":n?(va=-(Ea/2)+this.fontSize/2,ua=0>aa?Ha:-Ha):va=0>aa?Ea:-Ea}if(fa){if(isNaN(ga)||isNaN(ba))fa.remove(),fa=null;else if(ba+=ua,ga+=va,fa.translate(ba,ga),n){if(0>
ga||ga>l)fa.remove(),fa=null}else{var Cb=0;"3d"==I&&(Cb=z*Z);if(0>ba||ba>k+Cb)fa.remove(),fa=null}fa&&this.allBullets.push(fa)}}if("regular"==I||"100%"==I){var Db=e.totalText;if(Db){var Ia=this.createLabel(x,0,0,Db,e.totalTextColor);this.allBullets.push(Ia);var Eb=Ia.getBBox(),Fb=Eb.width,Gb=Eb.height,Qa,Ra,Hb=e.totals[J];Hb&&Hb.remove();var Sa=0;"column"!=g&&(Sa=Da);n?(Ra=C,Qa=0>S?D-Fb/2-2-Sa:D+Fb/2+3+Sa):(Qa=D,Ra=0>S?C+Gb/2+Sa:C-Gb/2-3-Sa);Ia.translate(Qa,Ra);e.totals[J]=Ia;n?(0>Ra||Ra>l)&&Ia.remove():
(0>Qa||Qa>k)&&Ia.remove()}}}}}}if("line"==g||"step"==g||"smoothedLine"==g)"smoothedLine"==g?this.drawSmoothedGraph(r,s,T,U):this.drawLineGraph(r,s,T,U),da||this.launchAnimation();this.bulletsHidden&&this.hideBullets()},animateColumns:function(a,b,c,d,f,e){var g=this;c=g.chart.startDuration;0<c&&!g.animationPlayed&&(g.seqAn?(a.set.hide(),g.animationArray.push(a),a=setTimeout(function(){g.animate.call(g)},c/(g.end-g.start+1)*(b-g.start)*1E3),g.timeOuts.push(a)):g.animate(a))},createLabel:function(a,
b,c,d,f){var e=this.chart,g=a.labelColor;g||(g=this.color);g||(g=e.color);f&&(g=f);f=this.fontSize;void 0===f&&(this.fontSize=f=e.fontSize);a=e.formatString(d,a,this);a=AmCharts.cleanFromEmpty(a);e=AmCharts.text(this.container,a,g,e.fontFamily,f);e.translate(b,c);this.bulletSet.push(e);return e},positiveClip:function(a){a.clipRect(this.pmx,this.pmy,this.pmw,this.pmh)},negativeClip:function(a){a.clipRect(this.nmx,this.nmy,this.nmw,this.nmh)},drawLineGraph:function(a,b,c,d){var f=this;if(1<a.length){var e=
f.set,g=f.container,h=g.set(),k=g.set();e.push(k);e.push(h);var l=f.lineAlpha,m=f.lineThickness,e=f.fillAlphas,n=f.lineColor,p=f.negativeLineAlpha;isNaN(p)&&(p=l);var q=f.lineColorSwitched;q&&(n=q);var q=f.fillColors,t=f.fillColorsSwitched;t&&(q=t);var r=f.dashLength;(t=f.dashLengthSwitched)&&(r=t);var t=f.negativeLineColor,s=f.negativeFillColors,w=f.negativeFillAlphas,v=f.baseCoord;0!==f.negativeBase&&(v=f.valueAxis.getCoordinate(f.negativeBase));l=AmCharts.line(g,a,b,n,l,m,r,!1,!0);h.push(l);h.click(function(){f.handleGraphClick()});
void 0!==t&&(m=AmCharts.line(g,a,b,t,p,m,r,!1,!0),k.push(m));if(0<e||0<w)if(m=a.join(";").split(";"),p=b.join(";").split(";"),"serial"==f.chartType&&(0<c.length?(c.reverse(),d.reverse(),m=a.concat(c),p=b.concat(d)):f.rotate?(p.push(p[p.length-1]),m.push(v),p.push(p[0]),m.push(v),p.push(p[0]),m.push(m[0])):(m.push(m[m.length-1]),p.push(v),m.push(m[0]),p.push(v),m.push(a[0]),p.push(p[0]))),a=f.gradientRotation,0<e&&(b=AmCharts.polygon(g,m,p,q,e,1,"#000",0,a),b.pattern(f.pattern),h.push(b)),s||void 0!==
t)isNaN(w)&&(w=e),s||(s=t),g=AmCharts.polygon(g,m,p,s,w,1,"#000",0,a),g.pattern(f.pattern),k.push(g),k.click(function(){f.handleGraphClick()});f.applyMask(k,h)}},applyMask:function(a,b){var c=a.length();"serial"!=this.chartType||this.scrollbar||(this.positiveClip(b),0<c&&this.negativeClip(a))},drawSmoothedGraph:function(a,b,c,d){if(1<a.length){var f=this.set,e=this.container,g=e.set(),h=e.set();f.push(h);f.push(g);var k=this.lineAlpha,l=this.lineThickness,f=this.dashLength,m=this.fillAlphas,n=this.lineColor,
p=this.fillColors,q=this.negativeLineColor,t=this.negativeFillColors,r=this.negativeFillAlphas,s=this.baseCoord,w=this.lineColorSwitched;w&&(n=w);(w=this.fillColorsSwitched)&&(p=w);w=this.negativeLineAlpha;isNaN(w)&&(w=k);k=new AmCharts.Bezier(e,a,b,n,k,l,p,0,f);g.push(k.path);void 0!==q&&(l=new AmCharts.Bezier(e,a,b,q,w,l,p,0,f),h.push(l.path));0<m&&(k=a.join(";").split(";"),n=b.join(";").split(";"),l="",0<c.length?(c.reverse(),d.reverse(),k=a.concat(c),n=b.concat(d)):(this.rotate?(l+=" L"+s+","+
b[b.length-1],l+=" L"+s+","+b[0]):(l+=" L"+a[a.length-1]+","+s,l+=" L"+a[0]+","+s),l+=" L"+a[0]+","+b[0]),c=new AmCharts.Bezier(e,k,n,NaN,0,0,p,m,f,l),c.path.pattern(this.pattern),g.push(c.path),t||void 0!==q)&&(r||(r=m),t||(t=q),a=new AmCharts.Bezier(e,a,b,NaN,0,0,t,r,f,l),a.path.pattern(this.pattern),h.push(a.path));this.applyMask(h,g)}},launchAnimation:function(){var a=this,b=a.chart.startDuration;if(0<b&&!a.animationPlayed){var c=a.set,d=a.bulletSet;AmCharts.VML||(c.attr({opacity:a.startAlpha}),
d.attr({opacity:a.startAlpha}));c.hide();d.hide();a.seqAn?(b=setTimeout(function(){a.animateGraphs.call(a)},a.index*b*1E3),a.timeOuts.push(b)):a.animateGraphs()}},animateGraphs:function(){var a=this.chart,b=this.set,c=this.bulletSet,d=this.x,f=this.y;b.show();c.show();var e=a.startDuration,a=a.startEffect;b&&(this.rotate?(b.translate(-1E3,f),c.translate(-1E3,f)):(b.translate(d,-1E3),c.translate(d,-1E3)),b.animate({opacity:1,translate:d+","+f},e,a),c.animate({opacity:1,translate:d+","+f},e,a))},animate:function(a){var b=
this.chart,c=this.animationArray;!a&&0<c.length&&(a=c[0],c.shift());c=AmCharts[AmCharts.getEffect(b.startEffect)];b=b.startDuration;a&&(this.rotate?a.animateWidth(b,c):a.animateHeight(b,c),a.set.show())},legendKeyColor:function(){var a=this.legendColor,b=this.lineAlpha;void 0===a&&(a=this.lineColor,0===b&&(b=this.fillColors)&&(a="object"==typeof b?b[0]:b));return a},legendKeyAlpha:function(){var a=this.legendAlpha;void 0===a&&(a=this.lineAlpha,0===a&&this.fillAlphas&&(a=this.fillAlphas),0===a&&(a=
this.bulletAlpha),0===a&&(a=1));return a},createBullet:function(a,b,c,d){d=this.container;var f=this.bulletOffset,e=this.bulletSize;isNaN(a.bulletSize)||(e=a.bulletSize);var g=a.values.value;isNaN(this.maxValue)||isNaN(g)||(e=g/this.maxValue*this.maxBulletSize);var h=e;this.bulletAxis&&(e=a.values.error,isNaN(e)||(g=e),e=this.bulletAxis.stepWidth*g);e<this.minBulletSize&&(e=this.minBulletSize);this.rotate?b+=f:c-=f;var k,l=this.bulletColor;a.lineColor&&(this.bulletColorSwitched=a.lineColor);this.bulletColorSwitched&&
(l=this.bulletColorSwitched);a.isNegative&&void 0!==this.bulletColorNegative&&(l=this.bulletColorNegative);void 0!==a.color&&(l=a.color);f=this.bullet;a.bullet&&(f=a.bullet);var g=this.bulletBorderThickness,m=this.bulletBorderColor,n=this.bulletBorderAlpha,p=this.bulletAlpha;m||(m=l);var q=a.alpha;isNaN(q)||(p=q);if("none"!=this.bullet||a.bullet)k=AmCharts.bullet(d,f,e,l,p,g,m,n,h);if(this.customBullet||a.customBullet)h=this.customBullet,a.customBullet&&(h=a.customBullet),h&&(k&&k.remove(),"function"==
typeof h?(k=new h,k.chart=this.chart,a.bulletConfig&&(k.availableSpace=c,k.graph=this,a.bulletConfig.minCoord=this.minCoord-c,k.bulletConfig=a.bulletConfig),k.write(d),k=k.set):(this.chart.path&&(h=this.chart.path+h),k=d.set(),d=d.image(h,0,0,e,e),k.push(d),this.centerCustomBullets&&d.translate(-e/2,-e/2)));k&&((a.url||this.showHandOnHover)&&k.setAttr("cursor","pointer"),"serial"==this.chartType&&(0>b-0||b-0>this.width||c<-e/2||c-0>this.height)&&(k.remove(),k=null),k&&(this.bulletSet.push(k),k.translate(b,
c),this.addListeners(k,a),this.allBullets.push(k)),a.bx=b,a.by=c);a.bulletGraphics=k;return e},showBullets:function(){var a=this.allBullets,b;this.bulletsHidden=!1;for(b=0;b<a.length;b++)a[b].show()},hideBullets:function(){var a=this.allBullets,b;this.bulletsHidden=!0;for(b=0;b<a.length;b++)a[b].hide()},addListeners:function(a,b){var c=this;a.mouseover(function(a){c.handleRollOver(b,a)}).mouseout(function(a){c.handleRollOut(b,a)}).touchend(function(a){c.handleRollOver(b,a);c.chart.panEventsEnabled&&
c.handleClick(b,a)}).touchstart(function(a){c.handleRollOver(b,a)}).click(function(a){c.handleClick(b,a)}).dblclick(function(a){c.handleDoubleClick(b,a)}).contextmenu(function(a){c.handleRightClick(b,a)})},handleRollOver:function(a,b){if(a){var c=this.chart,d={type:"rollOverGraphItem",item:a,index:a.index,graph:this,target:this,chart:this.chart,event:b};this.fire("rollOverGraphItem",d);c.fire("rollOverGraphItem",d);clearTimeout(c.hoverInt);d=this.showBalloon;c.chartCursor&&"serial"==this.chartType&&
(d=!1,!c.chartCursor.valueBalloonsEnabled&&this.showBalloon&&(d=!0));if(d){var d=c.formatString(this.balloonText,a,a.graph),f=this.balloonFunction;f&&(d=f(a,a.graph));d=AmCharts.cleanFromEmpty(d);f=c.getBalloonColor(this,a);c.balloon.showBullet=!1;c.balloon.pointerOrientation="V";var e=a.x,g=a.y;c.rotate&&(e=a.y,g=a.x);c.showBalloon(d,f,!0,e+c.marginLeftReal,g+c.marginTopReal)}}},handleRollOut:function(a,b){this.chart.hideBalloon();if(a){var c={type:"rollOutGraphItem",item:a,index:a.index,graph:this,
target:this,chart:this.chart,event:b};this.fire("rollOutGraphItem",c);this.chart.fire("rollOutGraphItem",c)}},handleClick:function(a,b){if(a){var c={type:"clickGraphItem",item:a,index:a.index,graph:this,target:this,chart:this.chart,event:b};this.fire("clickGraphItem",c);this.chart.fire("clickGraphItem",c);AmCharts.getURL(a.url,this.urlTarget)}this.handleGraphClick()},handleGraphClick:function(){var a={type:"clickGraph",graph:this,target:this,chart:this.chart};this.fire("clickGraph",a);this.chart.fire("clickGraph",
a)},handleRightClick:function(a,b){if(a){var c={type:"rightClickGraphItem",item:a,index:a.index,graph:this,target:this,chart:this.chart,event:b};this.fire("rightClickGraphItem",c);this.chart.fire("rightClickGraphItem",c)}},handleDoubleClick:function(a,b){if(a){var c={type:"doubleClickGraphItem",item:a,index:a.index,graph:this,target:this,chart:this.chart,event:b};this.fire("doubleClickGraphItem",c);this.chart.fire("doubleClickGraphItem",c)}},zoom:function(a,b){this.start=a;this.end=b;this.draw()},
changeOpacity:function(a){var b=this.set;b&&b.setAttr("opacity",a);if(b=this.ownColumns){var c;for(c=0;c<b.length;c++){var d=b[c].set;d&&d.setAttr("opacity",a)}}(b=this.bulletSet)&&b.setAttr("opacity",a)},destroy:function(){AmCharts.remove(this.set);AmCharts.remove(this.bulletSet);var a=this.timeOuts;if(a){var b;for(b=0;b<a.length;b++)clearTimeout(a[b])}this.timeOuts=[]}});AmCharts.ChartCursor=AmCharts.Class({construct:function(a){this.createEvents("changed","zoomed","onHideCursor","draw","selected");this.enabled=!0;this.cursorAlpha=1;this.selectionAlpha=0.2;this.cursorColor="#CC0000";this.categoryBalloonAlpha=1;this.color="#FFFFFF";this.type="cursor";this.zoomed=!1;this.zoomable=!0;this.pan=!1;this.categoryBalloonDateFormat="MMM DD, YYYY";this.categoryBalloonEnabled=this.valueBalloonsEnabled=!0;this.rolledOver=!1;this.cursorPosition="middle";this.bulletsEnabled=this.skipZoomDispatch=
!1;this.bulletSize=8;this.selectWithoutZooming=this.oneBalloonOnly=!1;this.graphBulletSize=1.7;this.animationDuration=0.3;AmCharts.applyTheme(this,a,"ChartCursor")},draw:function(){var a=this;a.destroy();var b=a.chart,c=b.container;a.rotate=b.rotate;a.container=c;c=c.set();c.translate(a.x,a.y);a.set=c;b.cursorSet.push(c);c=new AmCharts.AmBalloon;c.chart=b;a.categoryBalloon=c;AmCharts.copyProperties(b.balloon,c);c.cornerRadius=0;c.shadowAlpha=0;c.borderThickness=1;c.borderAlpha=1;c.showBullet=!1;var d=
a.categoryBalloonColor;void 0===d&&(d=a.cursorColor);c.fillColor=d;c.fillAlpha=a.categoryBalloonAlpha;c.borderColor=d;c.color=a.color;a.rotate&&(c.pointerOrientation="H");a.prevX=[];a.prevY=[];a.prevTX=[];a.prevTY=[];if(a.valueBalloonsEnabled)for(c=0;c<b.graphs.length;c++)d=new AmCharts.AmBalloon,d.chart=b,AmCharts.copyProperties(b.balloon,d),b.graphs[c].valueBalloon=d;"cursor"==a.type?a.createCursor():a.createCrosshair();a.interval=setInterval(function(){a.detectMovement.call(a)},40)},updateData:function(){var a=
this.chart;this.data=a.chartData;this.firstTime=a.firstTime;this.lastTime=a.lastTime},createCursor:function(){var a=this.chart,b=this.cursorAlpha,c=a.categoryAxis,d=c.position,f=c.inside,e=c.axisThickness,g=this.categoryBalloon,h,k,l=a.dx,m=a.dy,n=this.x,p=this.y,q=this.width,t=this.height,a=a.rotate,r=c.tickLength;g.pointerWidth=r;a?(h=[0,q,q+l],k=[0,0,m]):(h=[l,0,0],k=[m,0,t]);this.line=b=AmCharts.line(this.container,h,k,this.cursorColor,b,1);this.set.push(b);a?(f&&(g.pointerWidth=0),"right"==d?
f?g.setBounds(n,p+m,n+q+l,p+t+m):g.setBounds(n+q+l+e,p+m,n+q+1E3,p+t+m):f?g.setBounds(n,p,q+n,t+p):g.setBounds(-1E3,-1E3,n-r-e,p+t+15)):(g.maxWidth=q,c.parseDates&&(r=0,g.pointerWidth=0),"top"==d?f?g.setBounds(n+l,p+m,q+l+n,t+p):g.setBounds(n+l,-1E3,q+l+n,p+m-r-e):f?g.setBounds(n,p,q+n,t+p-r):g.setBounds(n,p+t+r+e-1,n+q,p+t+r+e));this.hideCursor()},createCrosshair:function(){var a=this.cursorAlpha,b=this.container,c=AmCharts.line(b,[0,0],[0,this.height],this.cursorColor,a,1),a=AmCharts.line(b,[0,
this.width],[0,0],this.cursorColor,a,1);this.set.push(c);this.set.push(a);this.vLine=c;this.hLine=a;this.hideCursor()},detectMovement:function(){var a=this.chart;if(a.mouseIsOver){var b=a.mouseX-this.x,c=a.mouseY-this.y;0<b&&b<this.width&&0<c&&c<this.height?(this.drawing?this.rolledOver||a.setMouseCursor("crosshair"):this.pan&&(this.rolledOver||a.setMouseCursor("move")),this.rolledOver=!0,this.setPosition()):this.rolledOver&&(this.handleMouseOut(),this.rolledOver=!1)}else this.rolledOver&&(this.handleMouseOut(),
this.rolledOver=!1)},getMousePosition:function(){var a,b=this.width,c=this.height;a=this.chart;this.rotate?(a=a.mouseY-this.y,0>a&&(a=0),a>c&&(a=c)):(a=a.mouseX-this.x,0>a&&(a=0),a>b&&(a=b));return a},updateCrosshair:function(){var a=this.chart,b=a.mouseX-this.x,c=a.mouseY-this.y,d=this.vLine,f=this.hLine,b=AmCharts.fitToBounds(b,0,this.width),c=AmCharts.fitToBounds(c,0,this.height);0<this.cursorAlpha&&(d.show(),f.show(),d.translate(b,0),f.translate(0,c));this.zooming&&(a.hideXScrollbar&&(b=NaN),
a.hideYScrollbar&&(c=NaN),this.updateSelectionSize(b,c));a.mouseIsOver||this.zooming||this.hideCursor()},updateSelectionSize:function(a,b){AmCharts.remove(this.selection);var c=this.selectionPosX,d=this.selectionPosY,f=0,e=0,g=this.width,h=this.height;isNaN(a)||(c>a&&(f=a,g=c-a),c<a&&(f=c,g=a-c),c==a&&(f=a,g=0));isNaN(b)||(d>b&&(e=b,h=d-b),d<b&&(e=d,h=b-d),d==b&&(e=b,h=0));0<g&&0<h&&(c=AmCharts.rect(this.container,g,h,this.cursorColor,this.selectionAlpha),c.translate(f+this.x,e+this.y),this.selection=
...
d,this.selectionPosY=f),this.zooming=!0)}}});AmCharts.SimpleChartScrollbar=AmCharts.Class({construct:function(a){this.createEvents("zoomed");this.backgroundColor="#D4D4D4";this.backgroundAlpha=1;this.selectedBackgroundColor="#EFEFEF";this.scrollDuration=this.selectedBackgroundAlpha=1;this.resizeEnabled=!0;this.hideResizeGrips=!1;this.scrollbarHeight=20;this.updateOnReleaseOnly=!1;9>document.documentMode&&(this.updateOnReleaseOnly=!0);this.dragIconWidth=18;this.dragIconHeight=25;AmCharts.applyTheme(this,a,"SimpleChartScrollbar")},draw:function(){var a=
...
a.categoryAxis;r.valueField=l.valueField;r.openField=l.openField;r.closeField=l.closeField;r.highField=l.highField;r.lowField=l.lowField;r.lineAlpha=a.graphLineAlpha;r.lineColor=a.graphLineColor;r.fillAlphas=a.graphFillAlpha;r.fillColors=a.graphFillColor;r.connect=l.connect;r.hidden=l.hidden;r.width=h;r.height=k;p=a.selectedGraph;p.id=l.id;p.rotate=f;p.chart=b;p.chartType=b.chartType;p.data=c;p.valueAxis=n;p.chart=l.chart;p.categoryAxis=d;p.valueField=l.valueField;p.openField=l.openField;p.closeField=
l.closeField;p.highField=l.highField;p.lowField=l.lowField;p.lineAlpha=a.selectedGraphLineAlpha;p.lineColor=a.selectedGraphLineColor;p.fillAlphas=a.selectedGraphFillAlpha;p.fillColors=a.selectedGraphFillColor;p.connect=l.connect;p.hidden=l.hidden;p.width=h;p.height=k;b=a.graphType;b||(b=l.type);r.type=b;p.type=b;c=c.length-1;r.zoom(0,c);p.zoom(0,c);p.set.click(function(){a.handleBackgroundClick()}).mouseover(function(){a.handleMouseOver()}).mouseout(function(){a.handleMouseOut()});r.set.click(function(){a.handleBackgroundClick()}).mouseover(function(){a.handleMouseOver()}).mouseout(function(){a.handleMouseOut()});
...
0)},handleBackgroundClick:function(){AmCharts.ChartScrollbar.base.handleBackgroundClick.call(this);this.dragging||(this.difference=this.end-this.start,this.timeDifference=this.endTime-this.startTime,0>this.timeDifference&&(this.timeDifference=0))}});AmCharts.AmBalloon=AmCharts.Class({construct:function(a){this.enabled=!0;this.fillColor="#FFFFFF";this.fillAlpha=0.8;this.borderThickness=2;this.borderColor="#FFFFFF";this.borderAlpha=1;this.cornerRadius=0;this.maximumWidth=220;this.horizontalPadding=8;this.verticalPadding=4;this.pointerWidth=6;this.pointerOrientation="V";this.color="#000000";this.adjustBorderColor=!0;this.show=this.follow=this.showBullet=!1;this.bulletSize=3;this.shadowAlpha=0.4;this.shadowColor="#000000";this.fadeOutDuration=this.animationDuration=
...
(A=k-y);var h=z+r,l=A+t,r=this.shadowAlpha,I=this.shadowColor,t=this.borderThickness,B=this.bulletSize,ca;0<v||0===s?(0<r&&(a=AmCharts.rect(f,y,u,n,0,t+1,I,r,this.cornerRadius),AmCharts.isModern?a.translate(1,1):a.translate(4,4),e.push(a)),n=AmCharts.rect(f,y,u,n,this.fillAlpha,t,p,this.borderAlpha,this.cornerRadius),this.showBullet&&(ca=AmCharts.circle(f,B,q,this.fillAlpha),e.push(ca))):(q=[],v=[],"H"!=w?(g=a-A,g>y-s&&(g=y-s),g<s&&(g=s),q=[0,g-s,a-A,g+s,y,y,0,0],v=H?[0,0,b-z,0,0,u,u,0]:[u,u,b-z,
u,u,0,0,u]):(q=b-z,q>u-s&&(q=u-s),q<s&&(q=s),v=[0,q-s,b-z,q+s,u,u,0,0],q=a<g+(k-g)/2?[0,0,A<a?0:a-A,0,0,y,y,0]:[y,y,A+y>a?y:a-A,y,y,0,0,y]),0<r&&(a=AmCharts.polygon(f,q,v,n,0,t,I,r),a.translate(1,1),e.push(a)),n=AmCharts.polygon(f,q,v,n,this.fillAlpha,t,p,this.borderAlpha));this.bg=n;e.push(n);n.toFront();f=1*this.deltaSignX;F.left=l+"px";F.top=h+"px";e.translate(A-f,z);n=n.getBBox();this.bottom=z+u+1;this.yPos=n.y+z;ca&&ca.translate(this.pointToX-A+f,b-z);b=this.animationDuration;0<this.animationDuration&&
...
a=a.split("[[value]]").join(d));a=AmCharts.massReplace(a,{"[[title]]":c.title,"[[description]]":b.description});a=AmCharts.fixNewLines(a);return a=AmCharts.cleanFromEmpty(a)},getBalloonColor:function(a,b,c){var d=a.lineColor,f=a.balloonColor;c&&(f=d);c=a.fillColors;"object"==typeof c?d=c[0]:void 0!==c&&(d=c);b.isNegative&&(c=a.negativeLineColor,a=a.negativeFillColors,"object"==typeof a?c=a[0]:void 0!==a&&(c=a),void 0!==c&&(d=c));void 0!==b.color&&(d=b.color);void 0===f&&(f=d);return f},getGraphById:function(a){return AmCharts.getObjById(this.graphs,
...
(h=[e,g],f=[d,f]):(h=[d,f],f=[e,g]),e=a.lineColor,d=AmCharts.line(c,h,f,e,a.lineAlpha,a.lineThickness,a.dashLength),g=h,k=f,n=h[1]-h[0],p=f[1]-f[0],l=n/Math.abs(n),m=p/Math.abs(p),p=n*p/Math.abs(n*p)*Math.sqrt(Math.pow(n,2)+Math.pow(p,2)),n=Math.asin(n/p),p=90*Math.PI/180-n,n=Math.abs(5*Math.cos(p)),p=Math.abs(5*Math.sin(p)),g.push(h[1]-l*p,h[0]-l*p),k.push(f[1]+m*n,f[0]+m*n),h=AmCharts.polygon(c,g,k,e,0.005,0),c=c.set([h,d]),c.translate(b.marginLeftReal,b.marginTopReal),b.trendLinesSet.push(c),a.line=
d,a.set=c,h.mouseup(function(){a.handleLineClick()}).mouseover(function(){a.handleLineOver()}).mouseout(function(){a.handleLineOut()}),h.touchend&&h.touchend(function(){a.handleLineClick()}))},handleLineClick:function(){var a={type:"click",trendLine:this,chart:this.chart};this.fire(a.type,a)},handleLineOver:function(){var a=this.rollOverColor;void 0!==a&&this.line.attr({stroke:a})},handleLineOut:function(){this.line.attr({stroke:this.lineColor})},destroy:function(){AmCharts.remove(this.set)}});AmCharts.circle=function(a,b,c,d,f,e,g,h){if(void 0==f||0===f)f=0.01;void 0===e&&(e="#000000");void 0===g&&(g=0);d={fill:c,stroke:e,"fill-opacity":d,"stroke-width":f,"stroke-opacity":g};a=a.circle(0,0,b).attr(d);h&&a.gradient("radialGradient",[c,AmCharts.adjustLuminosity(c,-0.6)]);return a};
...
AmCharts.wedge=function(a,b,c,d,f,e,g,h,k,l,m,n){var p=Math.round;e=p(e);g=p(g);h=p(h);var q=p(g/e*h),t=AmCharts.VML,r=359.5+e/100;359.94<r&&(r=359.94);f>=r&&(f=r);var s=1/180*Math.PI,r=b+Math.sin(d*s)*h,w=c-Math.cos(d*s)*q,v=b+Math.sin(d*s)*e,u=c-Math.cos(d*s)*g,A=b+Math.sin((d+f)*s)*e,F=c-Math.cos((d+f)*s)*g,y=b+Math.sin((d+f)*s)*h,s=c-Math.cos((d+f)*s)*q,z={fill:AmCharts.adjustLuminosity(l.fill,-0.2),"stroke-opacity":0},H=0;180<Math.abs(f)&&(H=1);d=a.set();var I;t&&(r=p(10*r),v=p(10*v),A=p(10*
A),y=p(10*y),w=p(10*w),u=p(10*u),F=p(10*F),s=p(10*s),b=p(10*b),k=p(10*k),c=p(10*c),e*=10,g*=10,h*=10,q*=10,1>Math.abs(f)&&1>=Math.abs(A-v)&&1>=Math.abs(F-u)&&(I=!0));f="";var B;0<k&&(t?(B=" M"+r+","+(w+k)+" L"+v+","+(u+k),I||(B+=" A"+(b-e)+","+(k+c-g)+","+(b+e)+","+(k+c+g)+","+v+","+(u+k)+","+A+","+(F+k)),B+=" L"+y+","+(s+k),0<h&&(I||(B+=" B"+(b-h)+","+(k+c-q)+","+(b+h)+","+(k+c+q)+","+y+","+(k+s)+","+r+","+(k+w)))):(B=" M"+r+","+(w+k)+" L"+v+","+(u+k)+(" A"+e+","+g+",0,"+H+",1,"+A+","+(F+k)+" L"+
y+","+(s+k)),0<h&&(B+=" A"+h+","+q+",0,"+H+",0,"+r+","+(w+k))),B+=" Z",B=a.path(B,void 0,void 0,"1000,1000").attr(z),d.push(B),B=a.path(" M"+r+","+w+" L"+r+","+(w+k)+" L"+v+","+(u+k)+" L"+v+","+u+" L"+r+","+w+" Z",void 0,void 0,"1000,1000").attr(z),k=a.path(" M"+A+","+F+" L"+A+","+(F+k)+" L"+y+","+(s+k)+" L"+y+","+s+" L"+A+","+F+" Z",void 0,void 0,"1000,1000").attr(z),d.push(B),d.push(k));t?(I||(f=" A"+p(b-e)+","+p(c-g)+","+p(b+e)+","+p(c+g)+","+p(v)+","+p(u)+","+p(A)+","+p(F)),e=" M"+p(r)+","+p(w)+
" L"+p(v)+","+p(u)+f+" L"+p(y)+","+p(s)):e=" M"+r+","+w+" L"+v+","+u+(" A"+e+","+g+",0,"+H+",1,"+A+","+F)+" L"+y+","+s;0<h&&(t?I||(e+=" B"+(b-h)+","+(c-q)+","+(b+h)+","+(c+q)+","+y+","+s+","+r+","+w):e+=" A"+h+","+q+",0,"+H+",0,"+r+","+w);a.handDrawn&&(b=AmCharts.line(a,[r,v],[w,u],l.stroke,l.thickness*Math.random()*a.handDrawThickness,l["stroke-opacity"]),d.push(b));a=a.path(e+" Z",void 0,void 0,"1000,1000").attr(l);if(m){b=[];for(c=0;c<m.length;c++)b.push(AmCharts.adjustLuminosity(l.fill,m[c]));
...
AmCharts.themes.redmond = {
	...
	DataSetSelector: {
		...
		fontFamily: "Covered By Your Grace",
		fontSize: "20px",
		selectedBackgroundColor: "#9d6478",
		rollOverBackgroundColor: "#000000",
		listCheckBoxSize: 20
	},
