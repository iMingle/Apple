$(document).ready(function() {
	...
	function startGame() {
		...
		playerSelected = false;			//大行星是否被选中
		playerMaxAbsVelocity = 30;		//最大速度
		playerVelocityDampener = 0.3;	//存储玩家所用行星的速度
		//根据powerX和powerY确定大行星的速度
		powerX = -1;
		powerY = -1;
	...
	function animate () {
		...
		var deadAsteroidLength = deadAsteroids.length;
		if (deadAsteroidLength > 0) {
			for (var di = 0; di < deadAsteroidLength; di++) {
